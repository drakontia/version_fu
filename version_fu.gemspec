...
Gem::Specification.new do |gem|
  gem.name = %q{version_fu}
  gem.version = Version_fu::VERSION

  gem.required_rubygems_version = Gem::Requirement.new(">= 0") if gem.respond_to? :required_rubygems_version=
  gem.authors = ["Jordan McKible"]
  gem.date = %q{2013-05-20}
  gem.description = %q{version_fu helps version your ActiveRecord models. It is based on Rick Olson's acts_as_versioned and is compatible with Rails 3.}
  gem.email = %q{}
  gem.licenses = "MIT"
  ...
  gem.summary = %q{Gemified version of the version_fu plugin.}
